...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash("This email has already registered for an account. "
                  "Please try signing in if you already have an account.")
    ...
    if form.validate_on_submit():
        ...
        if user:
            if check_password_hash(pwhash=user.password, password=form.password.data):
                ...
                flash("That password didn't match. Please try again.")
                return redirect(url_for("login"))
        else:
            flash("That email is not registered. Please register to our amazing website!")
